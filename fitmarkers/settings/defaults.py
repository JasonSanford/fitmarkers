...
ALLOWED_HOSTS = ['localhost', 'fitmarkers.com']
...
SECRET_KEY = '@l!^d)zl4=^5^sw6ul51s$k1=%2*3^_0b1fm7ri-l&*ev=$^n('
...
MIDDLEWARE_CLASSES = (
    ...
    'fitmarkers.middleware.ImpersonateMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'fitmarkers.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fitmarkers.wsgi.application'
